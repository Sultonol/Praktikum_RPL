...
<body>
        ...
        <a href="{{ route('film.index') }}" class="btn" style="margin-bottom: 20px; display: inline-block;">← Kembali ke Film </a>
        @if(count($jadwals) > 0)
        @else
        ...
        @if(count($jadwals) > 0)
            ...
            @foreach($jadwals as $jadwal)
                <div class="jadwal-box">
                    <p><strong>Tanggal:</strong> {{ \Carbon\Carbon::parse($jadwal->tanggal)->translatedFormat('d M Y') }}</p>
